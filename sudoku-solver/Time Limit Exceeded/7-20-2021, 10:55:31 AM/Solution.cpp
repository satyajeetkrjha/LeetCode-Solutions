...
public:
    ...
    void solveSudohelper(vector<vector <char>> & board,int i ,int j){
        
        // you are at index (3,3) so next time u move to (3,4) but if you are at (3,8) ,u do (4,0)
        if( i == board.size() ){
            return ;
        }
        int ni =0;
